...
problem = tsplib95.load('C:/Users/\Malek/Desktop/Evostar 2023/Experiment/Third experiments/jorlib-master/jorlib-master/jorlib-core/src/test/resources/tspLib/tsp/pr76.tsp')
...
for k in range(30):
    ...
    for i in range(75):
        for j in range(i+1, 76):
            ...
            dist_list = [(0,0,0) for x in range(2850)]  
    l = 0
    #for l in range(1000):
    while l < 2850:   
        for i in range(75):
    ...
    problem_fit = mlrose.TSPOpt(length = 76, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_pr_76.xlsx", index=True, startrow=0)
