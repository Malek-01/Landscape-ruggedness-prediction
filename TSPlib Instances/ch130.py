...
for k in range(30):
    ...
    problem_fit = mlrose.TSPOpt(length = 130, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_ch_130.xlsx", index=True, startrow=0)