...
problem = tsplib95.load('testdata/eil51.tsp')
...
for k in range(30):
    ...
    for i in range(50):
        for j in range(i+1, 51):
            ...
            dist_list = [(0,0,0) for x in range(1275)]  
    l = 0
    while l < 1275:   
        for i in range(50):
            for j in range(i+1, 51):
    ...
    problem_fit = mlrose.TSPOpt(length = 51, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_el_51.xlsx", index=True, startrow=0)