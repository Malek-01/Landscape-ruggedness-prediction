...
for k in range(30):
    ...
    problem_fit = mlrose.TSPOpt(length = 280, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_a280_280_1.xlsx", index=True, startrow=0)