...
for k in range(30):
    ...
    problem_fit = mlrose.TSPOpt(length = 417, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_fl_417.xlsx", index=True, startrow=0)