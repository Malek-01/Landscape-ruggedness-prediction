...
problem = tsplib95.load('testdata/berlin52.tsp')
...
for k in range(30):
    ...
    for i in range(51):
        for j in range(i+1, 52):
            ...
            dist_list = [(0,0,0) for x in range(1326)]  
    l = 0
    #for l in range(1000):
    while l < 1326:   
        for i in range(51):
    ...
    problem_fit = mlrose.TSPOpt(length = 52, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_Berlin_52.xlsx", index=True, startrow=0)