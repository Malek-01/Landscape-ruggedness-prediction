...
for k in range(30):
    ...
    problem_fit = mlrose.TSPOpt(length = 101, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_el_101.xlsx", index=True, startrow=0)