...
problem = tsplib95.load('testdata/ch150.tsp')
...
for k in range(30):
    ...
    for i in range(149):
        for j in range(i+1, 150):
            ...
            dist_list = [(0,0,0) for x in range(11175)]  
    l = 0
    while l < 11175:   
        for i in range(149):
            for j in range(i+1, 150):
    ...
    problem_fit = mlrose.TSPOpt(length = 150, fitness_fn = fitness_dists, maximize=False)
...
df.to_excel("TSP_ch_150.xlsx", index=True, startrow=0)