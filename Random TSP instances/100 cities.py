...
for k in range(30):
    ...
    dist_list = [(0,0,0) for x in range(4950)]  
    l = 0
    #for l in range(1000):
    while l < 4950:   
        for i in range(99):
    ...
    problem_fit = mlrose.TSPOpt(length = 100, fitness_fn = fitness_dists, maximize=False)
    
    # Create list of city coordinates
    coords_list = [(1, 1), (4, 2), (5, 2), (6, 4), (4, 4), (3, 6), (1, 5), (2, 3)]
    
    # Define optimization problem object
    problem_no_fit = mlrose.TSPOpt(length = 100, coords = fitness_dists, maximize=False)
...
df.to_excel("TSP_random_100.xlsx", index=True, startrow=0)
